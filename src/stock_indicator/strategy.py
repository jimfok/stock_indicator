...
def evaluate_combined_strategy(
    ...
    for csv_file_path, price_data_frame, symbol_mask in selected_symbol_data:
        # TODO: review
        # Keep a pristine copy for sell strategies so they do not reuse
        # indicators generated by the buy-side evaluation.
        ...
        # Build signals for all sell-side choices on the fresh frame
        sell_signal_columns: list[str] = []
